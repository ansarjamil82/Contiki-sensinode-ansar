...
/*
  ...
  */
	 ...
	 SENSORS_ACTIVATE(sht11_sensor);
	  ...
	  msg->sensors[BATTERY_VOLTAGE_SENSOR] = 0;//battery_sensor.value(0);
	  msg->sensors[BATTERY_INDICATOR] = 0;//sht11_sensor.value(SHT11_SENSOR_BATTERY_INDICATOR);
	  msg->sensors[LIGHT1_SENSOR] = 0;//light_sensor.value(LIGHT_SENSOR_PHOTOSYNTHETIC);
	  msg->sensors[LIGHT2_SENSOR] = 0;//light_sensor.value(LIGHT_SENSOR_TOTAL_SOLAR);
	  msg->sensors[TEMP_SENSOR] = (sht11_sensor.value(SHT11_SENSOR_TEMP)-42196)/1000;
	  msg->sensors[HUMIDITY_SENSOR] = 0;//sht11_sensor.value(SHT11_SENSOR_HUMIDITY);

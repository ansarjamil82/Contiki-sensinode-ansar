...
RELS += \
./cpu/avr/dev/usb/storage/avr_flash.rel \
./cpu/avr/dev/usb/storage/ctrl_access.rel \
./cpu/avr/dev/usb/storage/scsi_decoder.rel \
./cpu/avr/dev/usb/storage/storage_task.rel 


# Each subdirectory must supply rules for building sources it contributes
cpu/avr/dev/usb/storage/%.rel: ../cpu/avr/dev/usb/storage/%.c
	@echo 'Building file: $<'

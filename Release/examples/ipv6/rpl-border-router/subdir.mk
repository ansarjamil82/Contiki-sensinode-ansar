...
RELS += \
./examples/ipv6/rpl-border-router/border-router.rel \
./examples/ipv6/rpl-border-router/httpd-simple.rel \
./examples/ipv6/rpl-border-router/slip-bridge.rel 


# Each subdirectory must supply rules for building sources it contributes
examples/ipv6/rpl-border-router/%.rel: ../examples/ipv6/rpl-border-router/%.c
	@echo 'Building file: $<'
